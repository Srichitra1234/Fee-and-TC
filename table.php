...
$sql = "select * from notpaid where paidforyr='$paidforyr' and course='$course'";
...
<body>
    ...
    <tr>
        <th colspan='4' align="center"><h2 >Student Details</h2></th>
    </tr>
        <tr>
            <th>RollNumber</th>
            <th>Student Name</th>
        ...
        <tr>
                ...
                <td align="center"><?php echo $rows['due'];?></td>
        </tr>
        <?php
          }
        ?>
